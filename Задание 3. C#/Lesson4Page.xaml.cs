...
{
    /// <summary>
    /// Логика взаимодействия для Lesson4Page.xaml
    /// </summary>
    public partial class Lesson4Page : Page
    {
        ...
        {
            InitializeComponent();
            LoadWordDocument("Lessons\\Lesson4.docx");
        }
        ...
        // метод для перехода на следующий урок
        private void ButtonNextLesson_Click(object sender, RoutedEventArgs e)
        {
